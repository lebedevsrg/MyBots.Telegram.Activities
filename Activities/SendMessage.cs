...
namespace Telegram
{
    ...
    public sealed class SendMessage : CodeActivity
    {
        ...
        public SendMessage()
        {
            this.Constraints.Add(ActivityConstraints.HasParentType<SendMessage, TelegramConnector>(string.Format("Activity is valid only inside {0}", (object)typeof(TelegramConnector).Name)));
        }
