...
namespace Telegram
{
    ...
    public sealed class SendPhoto : CodeActivity
    {
        ...
        public SendPhoto()
        {
            this.Constraints.Add(ActivityConstraints.HasParentType<SendPhoto, TelegramConnector>(string.Format("Activity is valid only inside {0}", (object)typeof(TelegramConnector).Name)));
        }
